...
const TRANSLATIONS = {
  fr: {
    ...
    slapPileButton: "TAPE !",
    tributeOwed: "{player} doit sortir une figure ou un as ({attempts} essai(s) restant(s))",
    falseSlapBanner: "Fausse tape de {player} !",
    pileWonBanner: "{player} rafle le tas ({count} cartes) !",
    stockCount: "{count} cartes",
  ...
  en: {
    ...
    flipCardButton: "Flip",
    slapPileButton: "SLAP!",
    tributeOwed: "{player} must produce a figure or an ace ({attempts} attempt(s) left)",
    falseSlapBanner: "False slap by {player}!",
    pileWonBanner: "{player} takes the pile ({count} cards)!",
    stockCount: "{count} cards",
